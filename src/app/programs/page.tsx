...
export default async function ProgramsPage() {
  ...
  return (
    <AcademyShell
      ...
      badge={`${dataset.institutionName} · ${dataset.programs.length} programs`}
    >
        ...
        <CardContent>
          {dataset.programs.length === 0 ? (
            <div className="student-empty-state">
              ...
              <Link href="/settings/courses" className="academy-action-link">
                ...
                {dataset.programs.map((program) => {
                  ...
                  return (
                    <TableRow key={program.id}>
                      ...
                      <TableCell>
                        <Link href={`/programs/${program.id}`} className="academy-action-link">
                          Open program
                          <ArrowRight />
                        </Link>
                      </TableCell>
