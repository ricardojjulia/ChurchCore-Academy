...
export function aggregateModePackCapabilities(selectedModes: readonly InstitutionMode[]): InstitutionCapabilitySet {
  ...
  return packs.reduce<InstitutionCapabilitySet>(
    (capabilities, pack) => ({
      ...
      ministryFormation: capabilities.ministryFormation || pack.capabilities.ministryFormation,
      denominationTracking: capabilities.denominationTracking || pack.capabilities.denominationTracking,
      alumniGiving: capabilities.alumniGiving || pack.capabilities.alumniGiving,
